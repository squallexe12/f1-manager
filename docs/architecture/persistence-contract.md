...
**Last updated:** 2026-04-25 (Factory Box 1 Phase 1 — schema v9, adds two persisted team rolling buffers for the Factory car-performance card)
**Status:** Active
...
### Current state
- `SCHEMA_VERSION = 9`
- `MIGRATIONS = { 1: v1→v2, 2: v2→v3, 3: v3→v4, 4: v4→v5, 5: v5→v6, 6: v6→v7, 7: v7→v8, 8: v8→v9 }`

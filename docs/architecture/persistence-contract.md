...
**Last updated:** 2026-04-28 (Factory Box 3 Phase 3 — schema v11, adds aeroBookings ledger, upgradeOutcomes buffer, and per-upgrade WT/CFD cycle costs for the Factory aero-testing real-data wiring)
**Status:** Active
...
### Current state
- `SCHEMA_VERSION = 11`
- `MIGRATIONS = { 1: v1→v2, 2: v2→v3, 3: v3→v4, 4: v4→v5, 5: v5→v6, 6: v6→v7, 7: v7→v8, 8: v8→v9, 9: v9→v10, 10: v10→v11 }`

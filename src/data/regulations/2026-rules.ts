...
export const REG_2026: Record<RegId, RegEntry> = {
  "active-aero": {
    ...
    cards: ["aero"],
    briefing:
      "Front and rear wings adjust during the lap. Straight Mode reduces drag on full-throttle zones; Overtake Mode releases extra electric deployment for passing. DRS is gone.",
  },
  "no-mgu-h": {
    id: "no-mgu-h",
    ribbon: "NO MGU-H",
